...
# 1. Load data
combined <- readRDS("./results/1.2.1.merged-qc-20231102.rds")
dim(combined)
...
saveRDS(combined, file = "./results/1.3.1.merged-pca-20231102.rds")

pdf("./results/01-03-01-elbow.pdf", 
...
saveRDS(combined, file = "./results/1.3.2.merged-umap-20231102.rds")
...
pdf("./results/01-03-02-UMAP-cluster0.1.pdf", 
...
pdf("./results/01-03-02-UMAP-cluster0.2.pdf", 
    width = 12/2.54, height = 8/2.54)
DimPlot(combined, reduction = "umap", 
    group.by = "RNA_snn_res.0.2", 
    label = TRUE, pt.size = 0.2, label.size = 2.5, repel = FALSE) + 
...
pdf("./results/01-03-02-UMAP-cluster0.5.pdf", 
    width = 12/2.54, height = 8/2.54)
DimPlot(combined, reduction = "umap", 
...
pdf("./results/01-03-02-UMAP-cluster0.8.pdf", 
    width = 12/2.54, height = 8/2.54)
DimPlot(combined, reduction = "umap", 
...
pdf("./results/01-03-02-UMAP-cluster1.0.pdf", 
    width = 12/2.54, height = 8/2.54)
DimPlot(combined, reduction = "umap", 
...
pdf("./results/01-03-02-UMAP-cluster1.2.pdf", 
    width = 12/2.54, height = 8/2.54)
DimPlot(combined, reduction = "umap", 
...
pdf("./results/01-03-02-UMAP-cluster1.5.pdf", 
    width = 12/2.54, height = 8/2.54)
DimPlot(combined, reduction = "umap", 
...
pdf("./results/01-03-02-UMAP-cluster2.0.pdf", 
    width = 12/2.54, height = 8/2.54)
DimPlot(combined, reduction = "umap", 
...
pdf("./results/01-03-03-UMAP-group.pdf", 
...
pdf("./results/01-03-04-feature-cellcycle.pdf", 
...
pdf("./results/01-03-05-feature-celltype.pdf", 
...
pdf("./results/01-03-05-feature-celltype-b.pdf", 
...
# 6. markers
feature = read.table('./results/markers-epi.txt')
feature = feature$V1
pdf("./results/01-03-06-marker-epi.pdf", 
...
feature = read.table('./results/markers-fib.txt')
feature = feature$V1
pdf("./results/01-03-06-marker-fib.pdf", 
    width = 24/2.54, height = 24/2.54)
plots = list()
for(i in seq_along(feature)){
    plots[[i]] = FeaturePlot(combined, features = feature[i], label = FALSE, 
...
feature = read.table('./results/markers-imm.txt')
feature = feature$V1
pdf("./results/01-03-06-marker-imm.pdf", 
...
feature = read.table('./results/markers-neu.txt')
feature = feature$V1
pdf("./results/01-03-06-marker-neu.pdf", 
    width = 24/2.54, height = 24/2.54)
plots = list()
for(i in seq_along(feature)){
    plots[[i]] = FeaturePlot(combined, features = feature[i], label = FALSE, 
