...
# 1. Load data
combined <- readRDS("/workdir/wangph/proj/20231102_Jida/SC-3sample/1.5.1.merged-singleR-20231102.rds")
ann = read.csv("/workdir/wangph/proj/20231102_Jida/SC-3sample/1.7.1.ann.tsv", sep = '\t')
dim(ann)
...
saveRDS(combined, file = "/workdir/wangph/proj/20231102_Jida/SC-3sample/1.7.2.merged-ann-20231102.rds")
write.csv(combined@meta.data, file = "/workdir/wangph/proj/20231102_Jida/SC-3sample/1.7.2.meta.csv")



# 3.plot
pdf("/workdir/wangph/proj/20231102_Jida/SC-3sample/01-07-01-UMAP-harmony-ann.pdf", 
...
pdf("/workdir/wangph/proj/20231102_Jida/SC-3sample/01-07-02-bar.ann.withlegend.pdf", 
    width = 20/2.54, height = 8/2.54)
