...
for(i in c(1:nrow(comparisons))){	
	markers = FindMarkers(combined, 
		...
		logfc.threshold = 0)
	write.csv(markers, 
		paste("/workdir/wangph/proj/20231102_Jida/SC-3sample/01-09-01-dge-", comparisons$V1[i], 'vs', comparisons$V2[i], ".csv", sep = ""))
}
...
for(i in c(1:nrow(comparisons))){
	markers = read.csv(paste("/workdir/wangph/proj/20231102_Jida/SC-3sample/01-09-01-dge-", comparisons$V1[i], 'vs', comparisons$V2[i], ".csv", sep = ""),
	...
	pdf(paste("/workdir/wangph/proj/20231102_Jida/SC-3sample/01-09-01-dge-", comparisons$V1[i], 'vs', comparisons$V2[i], ".pdf", sep = ""), 
