...
# 1. Load data
combined <- readRDS("./results/1.3.2.merged-umap-20231102.rds")
dim(combined)
...
# saveRDS(combined, file = "./results/1.5.1.merged-singleR-20231102.rds")
...
pdf("./results/01-05-01-UMAP-singleR.main.pdf", 
...
pdf("./results/01-05-01-UMAP-singleR.fine.pdf", 
...
pdf("./results/01-05-02-UMAP-singleR.main-group.pdf", 
...
pdf("./results/01-05-02-UMAP-singleR.fine-group.pdf", 
    width = 28/2.54, height = 8/2.54)
DimPlot(combined, reduction = "umap", 
